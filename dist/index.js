...
class VideoPlayer {
    constructor(parentId, videoSrc, skipTime = 5, controlColor = "#a26f77", initialTheme = "dark") {
        ...
        this.controls.append(this.playBtn, this.backwardBtn, this.forwardBtn, this.timeRange, this.muteBtn, this.volumeSlider, this.speedSelect, this.fullScreenBtn, this.themeToggleBtn);
    ...
    toggleTheme() {
        ...
        this.themeToggleBtn.classList.replace(isLightTheme ? "fa-moon" : "fa-sun", isLightTheme ? "fa-sun" : "fa-moon");
    }
}
document.addEventListener("DOMContentLoaded", () => {
    new VideoPlayer("videoContainer", "./A Peek at pico - SNL.mp4", 10, "#FF7F50", "light");
